...
export default function Repos({ repos, searchByName, searchByTopic }: Props) {
    ...
    const linkToGithubPage = async (urlPage: string) => {
    ...
    // Função que filtra repositórios
    function filteredReposByTopic(topicParam: string): ReposProps[] | undefined {
    ...
    return (
        <main>
                        ...
                        <li className={`${styles.project_item} ${styles.active}`} key={index}>
                            ...
                            <div className={styles.repo_card}>
                                <div
                                    ...
                                    onClick={() => {setOpenIndex({ section: "filteredRepos", index })}}>
                                    <figure>
                                    ...
                                    {openIndex?.section === "filteredRepos" && openIndex.index === index && (
                                        <Modal onClose={() => setOpenIndex(null)} fullName={repo.full_name}>
            ...
            {filteredReposByTopic("angular") &&
                <section className={styles.repos}>
                    <h2 className={styles.subtitle}>
                        Angular
                    </h2>
                    {filteredReposByTopic("angular").map((repo, index) => (
                        <li className={`${styles.project_item} ${styles.active}`} key={index}>

                            <div className={styles.repo_card}>
                                <div
                                    className={styles.repo_card_content}
                                    onClick={() => {setOpenIndex({ section: "angular", index })}}>
                                    <figure>
                                        <img className={styles.repo_logo} src={formatRepoImg(repo.full_name)} alt={repo.full_name} loading="lazy" />
                                    </figure>
                                    <button
                                    ...
                                    {openIndex?.section === "angular" && openIndex.index === index && (
                                        <Modal onClose={() => setOpenIndex(null)} fullName={repo.full_name}>
            ...
            {filteredReposByTopic("react") &&
                <section className={styles.repos}>
                    <h2 className={styles.subtitle}>
                        React
                    </h2>
                    {filteredReposByTopic("react").map((repo, index) => (
                        <li className={`${styles.project_item} ${styles.active}`} key={index}>

                            <div className={styles.repo_card}>
                                <div
                                    className={styles.repo_card_content}
                                    onClick={() => {setOpenIndex({ section: "react", index })}}>
                                    <figure>
                                        <img className={styles.repo_logo} src={formatRepoImg(repo.full_name)} alt={repo.full_name} loading="lazy" />
                                    </figure>
                                    <button
                                    ...
                                    {openIndex?.section === "react" && openIndex.index === index && (
                                        <Modal onClose={() => setOpenIndex(null)} fullName={repo.full_name}>
            ...
            {filteredReposByTopic("python") &&
                <section className={styles.repos}>
                    <h2 className={styles.subtitle}>
                        Python
                    </h2>
                    {filteredReposByTopic("python").map((repo, index) => (
                        <li className={`${styles.project_item} ${styles.active}`} key={index}>

                            <div className={styles.repo_card}>
                                <div
                                    className={styles.repo_card_content}
                                    onClick={() => setOpenIndex({ section: "python", index })}>
                                    <figure>
                                        <img className={styles.repo_logo} src={formatRepoImg(repo.full_name)} alt={repo.full_name} loading="lazy" />
                                    </figure>
                                    <button
                                    ...
                                    {openIndex?.section === "python" && openIndex.index === index && (
                                        <Modal onClose={() => setOpenIndex(null)} fullName={repo.full_name}>
            ...
            {filteredReposByTopic("ui/ux design") &&
                <section className={styles.repos}>
                    <h2 className={styles.subtitle}>
                        UI/UX Design
                    </h2>
                    {filteredReposByTopic("ui/ux design").map((repo, index) => (
                        <li className={`${styles.project_item} ${styles.active}`} key={index}>

                            <div className={styles.repo_card}>
                                <div
                                    className={styles.repo_card_content}
                                    onClick={() => setOpenIndex({ section: "ui/ux design", index })}>
                                    <figure>
                                        <img className={styles.repo_logo} src={formatRepoImg(repo.full_name)} alt={repo.full_name} loading="lazy" />
                                    </figure>
                                    <button
                                    ...
                                    {openIndex?.section === "ui/ux design" && openIndex.index === index && (
                                        <Modal onClose={() => setOpenIndex(null)} fullName={repo.full_name}>
            ...
            {filteredReposByTopic("layout") &&
                <section className={styles.repos}>
                    <h2 className={styles.subtitle}>
                        Parts/Layout
                    </h2>
                    {filteredReposByTopic("layout").map((repo, index) => (
                        <li className={`${styles.project_item} ${styles.active}`} key={index}>

                            <div className={styles.repo_card}>
                                <div
                                    className={styles.repo_card_content}
                                    onClick={() => setOpenIndex({ section: "layout", index })}>
                                    <figure>
                                        <img className={styles.repo_logo} src={formatRepoImg(repo.full_name)} alt={repo.full_name} loading="lazy" />
                                    </figure>
                                    <button
                                    ...
                                    {openIndex?.section === "layout" && openIndex.index === index && (
                                        <Modal onClose={() => setOpenIndex(null)} fullName={repo.full_name}>
