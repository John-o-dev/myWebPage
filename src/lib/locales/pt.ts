export const pt = {
    ...
    degreesGallery: {
        ...
        title_header: 'Galeria de certificados',
        div_empty: 'Nenhum certificado encontrado',
        detail_card_overlay: 'Expandir',
        sections_title_description: 'Descrição Do Curso:',
        sections_title_goals: 'Objetivos:',
        sections_title_project: 'Projeto Desenvolvido:',
        sections_title_github: 'Ver repositório no GitHub:',
        more_info_title: 'Mais Informações',
        skill_list_skills: 'Habilidades',
        skill_list_listSkill: 'Lista:',
        skill_list_technical: 'Técnicas:',
        skill_list_technologies: 'Tecnologias:',
        skill_list_behavioral: 'Comportamentais:',
        skill_list_no_skills: 'Nenhuma habilidade encontrada',
        modal_fullscreen_activities: 'Atividades Desenvolvidas:',
        modal_fullscreen_content_learned: 'Conteúdo aprendido',
        details_certificate_expand: 'Ver Detalhes',
        details_certificate_duration: 'Carga horária:',
        details_certificate_date: 'Data de conclusão:',
        details_certificate_level: 'Nível:',
